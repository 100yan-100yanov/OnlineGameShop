    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity.authorizeHttpRequests(
                request -> request
                        ...
                        .requestMatchers("/admin/products", "/admin/products/add", "/admin/products/delete/**").hasRole(UserRole.ADMIN.name())
                        .requestMatchers("/admin/users", "/admin/users/delete/**").hasRole(UserRole.ADMIN.name())
